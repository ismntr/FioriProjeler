		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Person App ",
									"targetURL": "#project17person-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project17person-display": {
								"semanticObject": "project17person",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project17person",
									"url": sap.ui.require.toUrl("project17person")
								}
							}
						}
					}
