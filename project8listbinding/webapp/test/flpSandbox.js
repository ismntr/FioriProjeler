		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Binding App ",
									"targetURL": "#project8listbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project8listbinding-display": {
								"semanticObject": "project8listbinding",
								"action": "display",
								"description": "A List Binding Fiori application.",
								"title": "List Binding App ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project8listbinding",
									"url": sap.ui.require.toUrl("project8listbinding")
								}
							}
						}
					}
