		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator App with Reference",
									"targetURL": "#project6reference-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project6reference-display": {
								"semanticObject": "project6reference",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project6reference",
									"url": sap.ui.require.toUrl("project6reference")
								}
							}
						}
					}
