		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator App With Object",
									"targetURL": "#project5object-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project5object-display": {
								"semanticObject": "project5object",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project5object",
									"url": sap.ui.require.toUrl("project5object")
								}
							}
						}
					}
