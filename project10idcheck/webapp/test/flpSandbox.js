		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Id Ckeck App ",
									"targetURL": "#project10idcheck-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project10idcheck-display": {
								"semanticObject": "project10idcheck",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project10idcheck",
									"url": sap.ui.require.toUrl("project10idcheck")
								}
							}
						}
					}
