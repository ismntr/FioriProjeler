		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Contacts App",
									"targetURL": "#project7contacts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project7contacts-display": {
								"semanticObject": "project7contacts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project7contacts",
									"url": sap.ui.require.toUrl("project7contacts")
								}
							}
						}
					}
