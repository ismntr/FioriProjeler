		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Select App",
									"targetURL": "#project9listselect-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project9listselect-display": {
								"semanticObject": "project9listselect",
								"action": "display",
								"description": "A List Select Fiori application.",
								"title": "List Select App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project9listselect",
									"url": sap.ui.require.toUrl("project9listselect")
								}
							}
						}
					}
