		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Read Filter App ",
									"targetURL": "#project16readfilter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project16readfilter-display": {
								"semanticObject": "project16readfilter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project16readfilter",
									"url": sap.ui.require.toUrl("project16readfilter")
								}
							}
						}
					}
