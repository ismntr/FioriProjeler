		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Promise  App ",
									"targetURL": "#project14promise-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project14promise-display": {
								"semanticObject": "project14promise",
								"action": "display",
								"description": "A Promise Fiori application.",
								"title": "Promise  App ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project14promise",
									"url": sap.ui.require.toUrl("project14promise")
								}
							}
						}
					}
