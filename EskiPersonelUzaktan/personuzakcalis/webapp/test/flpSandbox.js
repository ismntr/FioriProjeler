		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#personuzakcalis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"personuzakcalis-display": {
								"semanticObject": "personuzakcalis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=personuzakcalis",
									"url": sap.ui.require.toUrl("personuzakcalis")
								}
							}
						}
					}
