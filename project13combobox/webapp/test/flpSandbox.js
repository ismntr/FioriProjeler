		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ComboBox App ",
									"targetURL": "#project13combobox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project13combobox-display": {
								"semanticObject": "project13combobox",
								"action": "display",
								"description": "A ComboBox Fiori application.",
								"title": "ComboBox App ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project13combobox",
									"url": sap.ui.require.toUrl("project13combobox")
								}
							}
						}
					}
