		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fragment App ",
									"targetURL": "#project11fragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project11fragment-display": {
								"semanticObject": "project11fragment",
								"action": "display",
								"description": "A fragment Fiori application.",
								"title": "fragment App ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project11fragment",
									"url": sap.ui.require.toUrl("project11fragment")
								}
							}
						}
					}
