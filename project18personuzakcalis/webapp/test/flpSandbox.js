		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "personuzakcalis App Title",
									"targetURL": "#project18personuzakcalis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project18personuzakcalis-display": {
								"semanticObject": "project18personuzakcalis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project18personuzakcalis",
									"url": sap.ui.require.toUrl("project18personuzakcalis")
								}
							}
						}
					}
