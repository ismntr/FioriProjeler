		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table App",
									"targetURL": "#project12table-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project12table-display": {
								"semanticObject": "project12table",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project12table",
									"url": sap.ui.require.toUrl("project12table")
								}
							}
						}
					}
