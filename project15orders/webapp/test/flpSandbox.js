		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order App",
									"targetURL": "#project15orders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project15orders-display": {
								"semanticObject": "project15orders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project15orders",
									"url": sap.ui.require.toUrl("project15orders")
								}
							}
						}
					}
